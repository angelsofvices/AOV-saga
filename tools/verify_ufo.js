...
"        row=[]",
"        for c in range(4):",
"            # JS-style half-UP rounding · python round() is banker's, and at",
"            # 940.5 the two disagree by a pixel — the draw uses Math.round,",
"            # so the measurement must too or r3c2 reads one row tall forever",
"            X0=int(c*CW+0.5); Y0=int(r*CH+0.5)",
"            X1=int((c+1)*CW+0.5); Y1=int((r+1)*CH+0.5)",
